...
public class menuController extends HttpServlet {
    ...
    // Fetch genres from the GenresDao
    GenresDao genDao = new GenresDao();
    List<Genres> genres = genDao.getAllGenres();

    // Fetch countries from the CountryDao
    CountriesDao countryDao = new CountriesDao();
    List<Country> countries = countryDao.getAllCountries(); // Assuming this method is in CountryDao
